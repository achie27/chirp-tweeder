    ...
    <Main>
      <MainContainer>
        <TweederDesc>
          ...
          <TweederSubHeadline>Use Tweeder to weed out tweets on certain domains made by certain authors from your timeline</TweederSubHeadline>
        </TweederDesc>
        <TweederLogin>
          <TweederLoginBox>
            <TweederLoginHeaderContainer>
              <TweederLoginHeader>Tweeder</TweederLoginHeader>
                <TweederLoginSubHeader>Tend to your Twitter timeline</TweederLoginSubHeader>
            </TweederLoginHeaderContainer>
            <TweederLoginButtonContainer>
              {
                loginStatus === "unauthenticated" ?
                  <TweederLoginButton onClick={() => signIn("twitter", { redirect: false })}>Sign in with Twitter</TweederLoginButton>
                :
                <TweederLoginButton>Checking your session ...</TweederLoginButton>
              }
            </TweederLoginButtonContainer>
          </TweederLoginBox>
        </TweederLogin>
