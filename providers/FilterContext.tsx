...
interface IFilterContext {
  ...
  filterUserCtxAnnotationMap: Record<
    string,
...
export const FilterContextProvider: FC<{ children: ReactNode }> = ({
  ...
  const [initialFilterLoadDone, setInitialFilterLoadDone] =
    useState<boolean>(false);
  const [filterUserCtxAnnotationMap, setFilterUserCtxAnnotationMap] = useState<
    IFilterContext["filterUserCtxAnnotationMap"]
  >({});
  ...
  useEffect(() => {
    ...
    setFilterUserCtxAnnotationMap(
      savedFilters.reduce((acc, cur) => {
