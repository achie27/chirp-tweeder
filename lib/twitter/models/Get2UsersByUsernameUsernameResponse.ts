...
/**
 * Check if a given object implements the Get2UsersByUsernameUsernameResponse interface.
 */
export function instanceOfGet2UsersByUsernameUsernameResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get2UsersByUsernameUsernameResponseFromJSON(json: any): Get2UsersByUsernameUsernameResponse {
    return Get2UsersByUsernameUsernameResponseFromJSONTyped(json, false);
}

export function Get2UsersByUsernameUsernameResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get2UsersByUsernameUsernameResponse {
...
export function Get2UsersByUsernameUsernameResponseToJSON(value?: Get2UsersByUsernameUsernameResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
