...
/**
 * Check if a given object implements the Get2SpacesIdTweetsResponse interface.
 */
export function instanceOfGet2SpacesIdTweetsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get2SpacesIdTweetsResponseFromJSON(json: any): Get2SpacesIdTweetsResponse {
    return Get2SpacesIdTweetsResponseFromJSONTyped(json, false);
}

export function Get2SpacesIdTweetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get2SpacesIdTweetsResponse {
...
export function Get2SpacesIdTweetsResponseToJSON(value?: Get2SpacesIdTweetsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
