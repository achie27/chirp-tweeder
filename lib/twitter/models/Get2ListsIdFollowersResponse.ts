...
/**
 * Check if a given object implements the Get2ListsIdFollowersResponse interface.
 */
export function instanceOfGet2ListsIdFollowersResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get2ListsIdFollowersResponseFromJSON(json: any): Get2ListsIdFollowersResponse {
    return Get2ListsIdFollowersResponseFromJSONTyped(json, false);
}

export function Get2ListsIdFollowersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get2ListsIdFollowersResponse {
...
export function Get2ListsIdFollowersResponseToJSON(value?: Get2ListsIdFollowersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
