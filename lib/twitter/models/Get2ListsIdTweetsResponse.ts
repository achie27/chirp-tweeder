...
/**
 * Check if a given object implements the Get2ListsIdTweetsResponse interface.
 */
export function instanceOfGet2ListsIdTweetsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get2ListsIdTweetsResponseFromJSON(json: any): Get2ListsIdTweetsResponse {
    return Get2ListsIdTweetsResponseFromJSONTyped(json, false);
}

export function Get2ListsIdTweetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get2ListsIdTweetsResponse {
...
export function Get2ListsIdTweetsResponseToJSON(value?: Get2ListsIdTweetsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
