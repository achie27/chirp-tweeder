...
/**
 * Check if a given object implements the Get2TweetsSampleStreamResponse interface.
 */
export function instanceOfGet2TweetsSampleStreamResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get2TweetsSampleStreamResponseFromJSON(json: any): Get2TweetsSampleStreamResponse {
    return Get2TweetsSampleStreamResponseFromJSONTyped(json, false);
}

export function Get2TweetsSampleStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get2TweetsSampleStreamResponse {
...
export function Get2TweetsSampleStreamResponseToJSON(value?: Get2TweetsSampleStreamResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
