...
/**
 * Check if a given object implements the Get2UsersIdMutingResponse interface.
 */
export function instanceOfGet2UsersIdMutingResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get2UsersIdMutingResponseFromJSON(json: any): Get2UsersIdMutingResponse {
    return Get2UsersIdMutingResponseFromJSONTyped(json, false);
}

export function Get2UsersIdMutingResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get2UsersIdMutingResponse {
...
export function Get2UsersIdMutingResponseToJSON(value?: Get2UsersIdMutingResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
